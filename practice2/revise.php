      ...
      <article>
        ...
        <form action="rev.php" method="post">
          <div class="form-group">
            <p>
              <label for="exampleInputEmail1">제목<input type="text" class="form-control" size = 100 name="title" value = "<?php echo $row['title'] ?>">
            </p>
          </div>
          <div class="from-group">
            <p>
              <label for="exampleInputEmail1">작성자<input type="text"class="form-control" size = 100 name="author" value = "<?php echo $row['name'] ?>">
            </p>
          </div>
          <div class="form-group">
            <p>
              <label for="exampleInputEmail1">본문<textarea name="description" rows = "30" cols = "100" class = "form-control" id = "description"><?php echo $row['description'] ?></textarea>
            </p>
          </div>
